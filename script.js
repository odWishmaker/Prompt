...
console.log(msg3);
var arithmeticMean = ((msg1) + (msg2) + (msg3) / 3);
console.log(arithmeticMean);
alert('You entered the following numbers: ' + (msg1) + ', ' + (msg2) + ', ' + (msg3) + '.' + ' The arithmetic mean is: ' + (arithmeticMean));
// third
let number = prompt('Enter three numbers without spaces, through a comma');
...
console.log(sum);
alert('You entered the following numbers: ' + number + '. ' + 'The arithmetic mean is: ' + sum + ' Good Luck!');
